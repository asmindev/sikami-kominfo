    ...
    return (
        <Card>
            <CardHeader className="pb-2">
                <CardTitle className="truncate text-sm font-bold text-muted-foreground" title={domainLabels[score.domain_name]}>
                    {domainLabels[score.domain_name] || score.domain_name}
                </CardTitle>
            </CardHeader>
            <CardContent>
                <div className="font-mono text-2xl font-bold">{final}</div>
                <div className="mt-4 flex items-center justify-between border-t pt-2 text-xs text-muted-foreground">
                    <div>
                        Bobot: <span className="font-semibold">{weightPercent}%</span>
                    </div>
                    <div>
                        Asli: <span className="font-semibold">{raw}</span>
                    </div>
                </div>
            </CardContent>
        </Card>
